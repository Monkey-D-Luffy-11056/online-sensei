...
import { ScrollView, View, Text, TouchableOpacity, Image, StyleSheet, Switch, SafeAreaView } from "react-native"
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileSection}>
          <View style={styles.profileImageContainer}>
            <Image source={{ uri: "https://picsum.photos/80/80?random=11" }} style={styles.profileImage} />
