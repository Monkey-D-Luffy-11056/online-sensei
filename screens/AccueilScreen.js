import { ScrollView, View, Text, TouchableOpacity, Image, StyleSheet, Dimensions, SafeAreaView } from "react-native"
            ...
            <TouchableOpacity key={article.id} style={styles.articleCard}>
              ...
              <View style={styles.articleContent}>
                ...
                <View style={styles.articleMeta}>
                  <Text style={styles.articleAuthor}>Par {article.auteur}</Text>
                  <Text style={styles.articleReadTime}>{article.tempsLecture}</Text>
                </View>
              </View>
            </TouchableOpacity>
          ))}
