...
import { ScrollView, View, Text, TouchableOpacity, Image, StyleSheet, TextInput, SafeAreaView } from "react-native"
            ...
            <View style={styles.articleContent}>
              ...
              <View style={styles.articleFooter}>
                <View style={styles.authorInfo}>
                  <Text style={styles.authorName}>Par {article.auteur}</Text>
                  <Text style={styles.readTime}>{article.tempsLecture}</Text>
                </View>
                <View style={styles.articleStats}>
                  ...
                  <View style={styles.statItem}>
                    ...
                    <Text style={styles.statText}>{article.commentaires}</Text>
                  </View>
                </View>
              </View>
            </View>
